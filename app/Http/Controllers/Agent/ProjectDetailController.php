...
use App\Http\Requests\Agent\ProjectDetailRequest;
use App\Models\Project;
use App\Models\Property;
use App\Models\PropertyType;
use Illuminate\Http\Request;
use App\Services\Agent\ProjectDetailService;
use Inertia\Inertia;
...
class ProjectDetailController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Agent/ProjectDetail/Index', $data);
    }
    ...
    public function addEdit(Request $request): Response
    {
        ...
        return Inertia::render('Agent/ProjectDetail/AddEdit', $data);
    }
