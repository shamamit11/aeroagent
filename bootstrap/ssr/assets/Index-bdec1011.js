...
/* empty css                *//* empty css                */const Index = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "action",
      width: "5%",
      render: (_, record) => /* @__PURE__ */ jsx(Space, { size: "middle", children: /* @__PURE__ */ jsx(Tooltip, { title: "View Detail", color: "orange", children: /* @__PURE__ */ jsx(Button, { style: { color: "orange", borderColor: "orange" }, size: "middle", shape: "circle", icon: /* @__PURE__ */ jsx(EyeOutlined, {}), onClick: () => handleEdit(record.id) }) }) })
    }
  ];
