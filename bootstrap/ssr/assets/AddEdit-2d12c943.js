...
const AddEdit = () => {
  ...
  const { data, setData, post, processing, errors } = useForm({
    ...
    unit_price: rowData == null ? void 0 : rowData.unit_price,
    market_price: rowData == null ? void 0 : rowData.market_price,
    ...
    /* @__PURE__ */ jsx("div", { className: "form-holder", children: /* @__PURE__ */ jsxs(
      Form,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(Row, { justify: "space-between", align: "middle", children: [
            /* @__PURE__ */ jsx(Col, { style: { width: "66%" }, children: /* @__PURE__ */ jsx(
              Form.Item,
              {
                label: "Building Name",
                name: "building_name",
