...
const Index = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: "13%",
      align: "center",
      render: (_, record) => /* @__PURE__ */ jsx(Space, { size: "middle", children: /* @__PURE__ */ jsx(Tooltip, { title: "Total Leasers", color: "orange", children: /* @__PURE__ */ jsx(Button, { type: "primary", size: "middle", shape: "circle", onClick: () => handleView(record.id), children: record.count }) }) })
    }
  ];
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Card, { bordered: false, style: { width: "100%", borderRadius: 0, paddingBottom: 20 }, children: [
      /* @__PURE__ */ jsxs(Row, { justify: "space-between", align: "middle", style: { marginBottom: 20, marginTop: 5 }, children: [
        /* @__PURE__ */ jsx(Col, { children: /* @__PURE__ */ jsx("span", { className: "page-title", children: "Leasers" }) }),
