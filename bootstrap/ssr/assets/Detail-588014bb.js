...
const Detail = () => {
  ...
  const onStatusMenuClick = (e) => {
    if (e.key == 2 || e.key == 3) {
      ...
      router.post("/buyer/updateStatus", formData, {
        onSuccess: () => {
          message.success("Status Updated Successfully !");
        },
        onError: () => {
          message.error("There was an error processing your request. Please try again !");
          router.get(`/buyer/detail?id=${rowData.id}`);
        },
        onFinish: () => {
          router.get(`/buyer/detail?id=${rowData.id}`);
        }
            ...
            /* @__PURE__ */ jsxs(Row, { justify: "space-between", align: "top", children: [
              ...
              /* @__PURE__ */ jsxs(Col, { style: { width: "32%" }, children: [
                ...
                /* @__PURE__ */ jsxs(Space, { size: "small", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { children: rowData == null ? void 0 : rowData.project_name })
                ] }),
                /* @__PURE__ */ jsx(Divider, {}),
                /* @__PURE__ */ jsxs(Space, { size: "small", children: [
              ...
              /* @__PURE__ */ jsxs(Col, { style: { width: "32%" }, children: [
                ...
                /* @__PURE__ */ jsx(Divider, {}),
                /* @__PURE__ */ jsxs(Space, { size: "small", children: [
                  /* @__PURE__ */ jsx("span", { style: { fontWeight: 600 }, children: "Interest:" }),
                  /* @__PURE__ */ jsx("span", { children: rowData == null ? void 0 : rowData.interest_label })
                ] }),
                /* @__PURE__ */ jsx(Divider, {})
              ] })
            ] }),
