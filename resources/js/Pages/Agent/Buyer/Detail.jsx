    ...
    return (
        <>
            <Card bordered={false} style={{ width: "100%", borderRadius: 0, paddingBottom: 20 }}>
                <Head title={lang.com.buyer_details} />
                                ...
                                <Row justify={'space-between'} align={'top'}>
                                    <Col style={{ width: "32%" }}>
                                        ...
                                        <Space size={"small"}>
                                            ...
                                            <span>{getObjectValue(lang, "com", rowData?.market_label)}</span>
                                        </Space>
                                        <Divider />
                                        <Space size={"small"}>
                                    ...
                                    <Col style={{ width: "32%" }}>
                                        ...
                                        <Divider />
                                        <Space size={"small"}>
                                            <span style={{ fontWeight: 600 }}>{lang.com.interest} :</span>
                                            <span>{getObjectValue(lang, "com", rowData?.interest_label)}</span>
                                        </Space>
                                        <Divider />
                                    </Col>
                                </Row>
